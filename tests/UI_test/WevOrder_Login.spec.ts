...
test('Login with valid creds ', async ({ page }) => {
  ...
  await page.getByRole('textbox', { name: 'Customer name:*' }).fill('S');
  ...
  await page.getByRole('textbox', { name: 'State:' }).fill('K');
  ...
  await page.getByRole('textbox', { name: 'Card Nr:*' }).press('ArrowLeft');
